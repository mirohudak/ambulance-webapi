	...
	return []Route{ 
		{
			"GetConditions",
			http.MethodGet,
			"/mhx-api/waiting-list/:ambulanceId/condition",
			handleFunctions.AmbulanceConditionsAPI.GetConditions,
		},
		{
			"CreateWaitingListEntry",
			http.MethodPost,
			"/mhx-api/waiting-list/:ambulanceId/entries",
			handleFunctions.AmbulanceWaitingListAPI.CreateWaitingListEntry,
		},
		{
			"DeleteWaitingListEntry",
			http.MethodDelete,
			"/mhx-api/waiting-list/:ambulanceId/entries/:entryId",
