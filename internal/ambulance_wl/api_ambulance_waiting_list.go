...
type AmbulanceWaitingListAPI interface {
    ...
    // CreateWaitingListEntry Post /mhx-api/waiting-list/:ambulanceId/entries
    // Saves new entry into waiting list 
     CreateWaitingListEntry(c *gin.Context)

    // DeleteWaitingListEntry Delete /mhx-api/waiting-list/:ambulanceId/entries/:entryId
    // Deletes specific entry 
     DeleteWaitingListEntry(c *gin.Context)

    // GetWaitingListEntries Get /mhx-api/waiting-list/:ambulanceId/entries
    // Provides the ambulance waiting list 
     GetWaitingListEntries(c *gin.Context)

    // GetWaitingListEntry Get /mhx-api/waiting-list/:ambulanceId/entries/:entryId
    // Provides details about waiting list entry 
     GetWaitingListEntry(c *gin.Context)

    // UpdateWaitingListEntry Put /mhx-api/waiting-list/:ambulanceId/entries/:entryId
